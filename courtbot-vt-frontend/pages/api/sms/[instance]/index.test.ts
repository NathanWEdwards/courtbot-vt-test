import { eventAsCase, randomPhoneNumber, subscribe } from '../../../../utils/tests';
...
describe('handler()', () => {
    describe('Given the same court session and same phone number', () => {
        ...
        test('When a user confirms \'yes\' to receive a notification, a reminder document associated to the subscriber notification confirmation exists.', async () => {
